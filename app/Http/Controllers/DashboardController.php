...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        if ($user->hasRole('dosen')) {
            $profile = DosenProfile::where('user_id', $user->id)->first() ?? new DosenProfile(['user_id' => $user->id]);
            ...
            // Mengganti 'dashboard.dosen' menjadi 'dashboard.beranda'
            return view('dashboard.beranda', compact('profile', 'proposals', 'laporans', 'luarans', 'keuangans'));
        }
